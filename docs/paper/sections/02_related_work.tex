...
optimisation), and objective (cost-asymmetric multi-quantile pinball
rather than MSE on DELPHI states). Our framework is related to
Elmachtoub and Grigas's Smart Predict-then-Optimize
framework~\cite{elmachtoub2022smart}, but remains a decoupled
forecast-then-optimise pipeline rather than training directly on
decision regret. It also draws on Luo and
...
Weighted Interval Score evaluation~\cite{bracher2021evaluating}.
...
under a cost-asymmetric quantile forecasting objective.
