...
The fixed clinical constants
$(\alpha,\rho,d_s,d_a,d_H,\omega,\mu,\phi)$ take the values in
\cite[Table~1]{ajao2025hybrid}; rates have units of
...
Once pre-trained the PINN is frozen and evaluated, never refit, at every
