...
shows the flow topology. The system evolves as
...
time-varying region-specific parameters learned from data.
...
adaptation that a per-origin refit gives for free. \emph{(ii)~Persistence
