...
A \emph{level-and-trend anchor} makes the GRU's job residual. The anchored forecast is
...
steps. The first corrects the bias, subtracting at
...
a model-agnostic post-hoc correction supplying the per-origin adaptation a refit
gives ARIMA for free. The second blends
