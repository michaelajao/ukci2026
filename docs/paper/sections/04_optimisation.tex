...
\Big)\;+\;\lambda_3\, W.
\end{equation}
This scenario-weighted LP up-weights high demand; it is not robust
optimisation formally. With one tail scenario,
$W=\sum_{r,h}u_{r,h}^{\text{high}}$, so $\lambda_3W$ is an extra high-tail
penalty, not conditional value-at-risk. We call it the robust LP for
brevity and report $\lambda_3{=}1$
